...
const file_proto_resiliency_resiliency_proto_rawDesc = "" +
	...
	"resiliency\x1a\"proto/google/api/annotations.proto\x1a4proto/protoc-gen-openapiv2/options/annotations.proto\"\xb8\x02\n" +
	"\x11ResiliencyRequest\x12a\n" +
	...
	"\fstatus_codes\x18\x03 \x03(\rB9\x92A624Array of gRPC status codes to be generated (numeric)R\fstatus_codes\"X\n" +
	"\x12ResiliencyResponse\x12B\n" +
	"\fdummy_string\x18\x01 \x01(\tB\x1e\x92A\x1b2\x19Dummy string for responseR\fdummy_string2\xd8\x04\n" +
	"\x11ResiliencyService\x12r\n" +
	"\x0fUnaryResiliency\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/api/resiliency/v1/unary\x12\xaf\x01\n" +
	"\x19ServerStreamingResiliency\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"Q\x82\xd3\xe4\x93\x02K\x12I/api/resiliency/v1/server_streaming/{min_delay_second}/{max_delay_second}0\x01\x12\x89\x01\n" +
	"\x19ClientStreamingResiliency\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"+\x82\xd3\xe4\x93\x02%\x12#/api/resiliency/v1/client_streaming(\x01\x12\x90\x01\n" +
	"\x17BiDirectionalResiliency\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"2\x82\xd3\xe4\x93\x02,\x12*/api/resiliency/v1/bidirectional_streaming(\x010\x012\xd5\t\n" +
	"\x1dResiliencyWithMetadataService\x12\x8a\x01\n" +
	"\x1bUnaryResiliencyWithMetadata\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\",\x82\xd3\xe4\x93\x02&:\x01*\"!/api/resiliency/v1/metadata/unary\x12\xdf\x02\n" +
	"%ServerStreamingResiliencyWithMetadata\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"\xf4\x01\x92A\xb9\x01\x121Summary for ServerStreamingResiliencyWithMetadata\x1a5Description for ServerStreamingResiliencyWithMetadataJ&\n" +
	"\x03200\x12\x1f\n" +
	"\x1dSample response, 200 when ...J%\n" +
	"\x03400\x12\x1e\n" +
	"\x1cSample response, 400 when ..\x82\xd3\xe4\x93\x021:\x01*\",/api/resiliency/v1/metadata/server_streaming0\x01\x12\xdf\x02\n" +
	"%ClientStreamingResiliencyWithMetadata\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"\xf4\x01\x92A\xb9\x01\x121Summary for ClientStreamingResiliencyWithMetadata\x1a5Description for ClientStreamingResiliencyWithMetadataJ&\n" +
	"\x03200\x12\x1f\n" +
	"\x1dSample response, 200 when ...J%\n" +
	"\x03400\x12\x1e\n" +
	"\x1cSample response, 400 when ..\x82\xd3\xe4\x93\x021:\x01*\",/api/resiliency/v1/metadata/client_streaming(\x01\x12\xe2\x02\n" +
	"#BiDirectionalResiliencyWithMetadata\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"\xf7\x01\x92A\xb5\x01\x12/Summary for BiDirectionalResiliencyWithMetadata\x1a3Description for BiDirectionalResiliencyWithMetadataJ&\n" +
	"\x03200\x12\x1f\n" +
	"\x1dSample response, 200 when ...J%\n" +
	"\x03400\x12\x1e\n" +
